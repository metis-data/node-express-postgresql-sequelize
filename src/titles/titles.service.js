...
module.exports = {
  ...
  titlesForAnActor(nconst, method) {
  ...
  highestRatedMoviesForAnActor(nconst, method) {
  ...
  highestRatedMovies(numvotes, method) {
  ...
  commonMoviesForTwoActors(actor1, actor2, method) {
  ...
  crewOfGivenMovie(tconst, method) {
  ...
  mostProlificActorInPeriod(startYear, endYear, method) {
  ...
  mostProlificActorInGenre(genre, method) {
  ...
  mostCommonTeammates(nconst, method) {
